    ...
    <div className="min-h-screen bg-slate-50 px-6 py-6 text-slate-700">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <div className="mt-1 text-sm text-slate-500">System updates and activity alerts</div>
        </div>
            ...
            <div className="inline-flex rounded-xl bg-slate-100 p-1">
              <button
                ...
                className={cx(
                  ...
                  tab === "all" ? "bg-white shadow text-slate-800" : "text-slate-600"
                )}
              >
                All
              </button>
              <button
                ...
                className={cx(
                  "rounded-lg px-4 py-2 text-sm font-semibold",
                  tab === "unread" ? "bg-white shadow text-slate-800" : "text-slate-600"
                )}
              >
                Unread
              </button>
          ...
          rows.map((r) => {
            ...
            return (
              <div
                key={r.id}
                className={cx(
                  "border-t border-slate-100 px-5 py-4 transition",
